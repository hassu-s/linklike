document.addEventListener("DOMContentLoaded", function() {
    ...
    popupMenu.innerHTML = `
        ...
        <div class="btnl"><a href="https://hassu-s.github.io/linklike/html/item.html"><button class="btna"><img id="lani" src="/linklike/image/button/news.png"><span id="lans">アーカイブ<span></button></a></div>
